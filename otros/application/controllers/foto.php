...
class Foto extends CI_Controller {
    ...
    public function searchImagen(){
        $idUsuario= $this->input->post('idUsuario', TRUE);
        $idTipoImagen= $this->input->post('id_tipo_imagen', TRUE);
        $respuesta_foto= $this->datospersonales_model->searchFoto($idUsuario,$idTipoImagen);
        echo json_encode($respuesta_foto);
    }
}
?>