...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-02-2016 a las 21:33:25
...
(1, 1, 0, '', 1, 0),
(31, 1, 1, 'Prueba', 1, 24),
(32, 1, 6, 'prueba de Cedula de Habitalidad', 1, 25);
...
INSERT INTO `visado_tecnico` (`id_visado_tecnico`, `id_condicion_visado`, `id_visado_servicio`) VALUES
(1, 2, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
--
ALTER TABLE `rol_operacion`
  MODIFY `id_rol_operacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `servicio_forma_pago`
  MODIFY `id_servicio_forma_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `tipologia_superficie`
  MODIFY `id_tipologia_superficie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;
--
...
--
ALTER TABLE `visado_servicio`
  MODIFY `id_visado_servicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
-- AUTO_INCREMENT de la tabla `visado_tecnico`
--
ALTER TABLE `visado_tecnico`
  MODIFY `id_visado_tecnico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
