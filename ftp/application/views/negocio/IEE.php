<div class="tab-content">
	...
	<form action="<?= base_url()."negocio/activarServicio"."/".$id."/".$idPersona?>" method="post"> 
					...
					<?php
                       for ($i=0; $i < count($antiguedad); $i++) { 
                           ...
                           for ($k=1; $k < 7; $k++) { 
                            ...
                            echo '<input type="text" name="precio[]" value="'.$antiguedad[$i][$k]['precio_antiguedad2'].'" size="5" maxlength="8" onkeyPress="return validarNumero(event)"> <br>';
		...
		<div id="sombra">
			<label>
			  <input type="checkbox" name="visado_s" value="Si" id="visado_si"> Si
			  <div id="visado">
		    ...
		    <br>
		    <label>
		      <input type="checkbox" name="visado_s" value="No" id="visado_no"> No
		    </label>
		</div>
