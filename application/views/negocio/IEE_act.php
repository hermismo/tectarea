...
<div class="tab-content">
	...
	<form action="<?= base_url()."negocio/activarServicio"."/".$id."/".$idPersona?>" method="post" id="form"> 
	 <input type="hidden" id='' name="id_servicio" value="<?php echo $id_servicio;?>">
      ...
      <input type="hidden" id='' name="servicio" value="IEE">  
							<div id="sombra">
		...
		<div id="sombra">
			<label>
			  <input type="checkbox" name="visado_s" value="Si" id="visado_si" <?php if ($antiguedad['visado'] == 1) echo 'checked="checked"';?>> Si
			  <div id="visado">
		    ...
		    <br>
		    <label>
		      <input type="checkbox" name="visado" value="no" id="visado_no" <?php if ($antiguedad['visado'] == 2) echo 'checked="checked"';?>> No
		    </label>
		</div>
