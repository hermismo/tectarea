<div class="tab-content">
	...
	<form action="<?= base_url()."negocio/activarServicio"."/".$id."/".$idPersona?>" method="post">
					...
					<?php
		               for ($i=0; $i < count($datos); $i++) { 
		                   ...
		                   for ($k=1; $k < 8; $k++) { 
		                   	...
		                   	echo '<input type="text" name="precio[]" value="'.$datos[$i][$k]['precio'].'" size="5" onkeyPress="return validarNumero(event)" maxlength="8" required> <br>';
		...
		<div id="sombra">
			<label>
			  <input type="radio" name="visado" value="Si" id="visado_si" required> Si
			  <div id="">
		    ...
		    <br>
		    <label>
		      <input type="radio" name="visado" value="no" id="visado_no" required> No
		    </label>
		</div>
