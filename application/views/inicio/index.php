    ...
    <!-- /.panel-heading -->
        <div class="panel-body">
            ...
            <ul class="nav nav-pills">
                ...
                <li><a href="<?php echo base_url()."inicio/negocio/".$id."/".$idPersona?>">Mi negocio</a></li>
                <li><a href="<?php echo base_url()."inicio/cuenta/".$id."/".$idPersona?>" id="cuenta">Mi cuenta</a></li>
